...
public class viewUnit {
    ...
    viewUnit() {
        JFrame frame = new JFrame("View Units");
        ...
        mainPanel.add(UIUtils.createHeaderPanel("Units List"), BorderLayout.NORTH);

        String[] cols = {"Unit ID", "Property ID", "Unit Number", "Floor", "Status", "Rent", "Tenant ID"};
        ...
        try {
            ...
            while(rs.next()) {
                model.addRow(new Object[]{
                    ...
                    rs.getString("Status"),
                    String.format("$%.2f", rs.getDouble("MonthlyRent")),
                    rs.getObject("TenantID") != null ? rs.getInt("TenantID") : "Unassigned"
                });
            }
